...
public class VentanaAddAd extends JFrame {

    public VentanaAddAd(String titulo, Control gestor) {
        super(titulo);
        this.gestor = gestor;
    ...
    public void ajustarComponentes(Container c){
       c.setLayout(new BorderLayout());
        ...
        gen.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(new Color(13,159,238)), "Nuevo Administrador"));
